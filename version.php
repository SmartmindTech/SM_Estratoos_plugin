...
$plugin->version = 2025012895;  // YYYYMMDDXX format.
$plugin->requires = 2022112800; // Moodle 4.1+
$plugin->maturity = MATURITY_STABLE;
$plugin->release = '2.0.95';  // Fix refresh resume: LMSInitialize wrapper always installed + iSpring post-load navigation.
