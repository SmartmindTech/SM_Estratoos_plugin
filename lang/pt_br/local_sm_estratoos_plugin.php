...
Para instalar a atualização, acesse: Administração do site > Plugins > Plugins locais > SmartMind Estratoos Plugin';
...
<p><a href="/local/sm_estratoos_plugin/update.php" class="btn btn-primary">Instalar atualização</a></p>';
...
// Expiração de acesso de empresas (v1.7.29).
$string['expirydate'] = 'Data de expiração';
$string['never'] = 'Nunca';
$string['selectdate'] = 'Selecionar data...';
$string['expired'] = 'Expirado';
$string['companyexpired'] = 'O acesso da empresa expirou';
$string['task:expirecompanyaccess'] = 'Expirar acesso de empresas';
$string['expirydate_help'] = 'Defina uma data de expiração para o acesso. Deixe vazio para nunca.';

// Funções API (v1.7.29).
$string['tokendetails'] = 'Detalhes do Token';
$string['companiesaccessstatus'] = 'Status de Acesso das Empresas';
$string['daysremaining'] = 'Dias restantes';
$string['tokennotfound'] = 'Token não encontrado';
$string['invalidtoken'] = 'Token inválido';
$string['accessdenied'] = 'Acesso negado';

// Rastreamento de versão do plugin (v1.7.37).
$string['pluginversion'] = 'Versão do plugin';
$string['pluginversion_help'] = 'A versão do plugin para esta empresa. Permite o rastreamento de versões independente por empresa.';
$string['updatecompanypluginversion'] = 'Atualizar versão do plugin da empresa';
$string['versionupdated'] = 'Versão do plugin atualizada com sucesso';
$string['invalidversionformat'] = 'Formato de versão inválido. Formato esperado: X.Y.Z (ex: 1.7.37)';

// Seção de atualizações do dashboard (v1.7.42).
$string['managepluginupdates'] = 'Gerenciar Atualizações do Plugin';
$string['managepluginupdatesdesc'] = 'Visualizar e sincronizar versões do plugin em todas as empresas.';
$string['installedversion'] = 'Versão instalada';
$string['updateallcompanies'] = 'Sincronizar Todas as Empresas';
$string['syncversion'] = 'Sincronizar';
$string['needsupdate'] = 'Precisa atualização';
$string['uptodate'] = 'Atualizado';
$string['allcompaniesuptodate'] = 'Todas as empresas estão usando a última versão';
$string['versionsynced'] = 'Versão sincronizada para {$a}';
$string['versionsyncfailed'] = 'Erro ao sincronizar a versão para {$a}';
