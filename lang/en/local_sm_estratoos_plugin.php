...
To install the update, go to: Site Administration > Plugins > Local plugins > SmartMind Estratoos Plugin';
...
$string['companiesselected'] = 'companies selected';
...
// User Creation APIs (v2.1.30).
$string['createusers'] = 'Create Users';
$string['createusersdesc'] = 'Create new Moodle users with automatic token generation. Users are tracked for SmartLearning integration.';
$string['singleuser'] = 'Single User';
$string['singleuserdetails'] = 'User Details';
$string['creationmethod'] = 'Creation method';
$string['generatepassword'] = 'Generate random password';
$string['generatepassword_desc'] = 'Automatically generate a random password for the user.';
$string['phoneintlcode'] = 'Phone country code';
$string['phoneintlcode_help'] = 'International phone code (e.g. +55 for Brazil, +1 for USA).';
$string['birthdate'] = 'Date of birth';
$string['stateprovince'] = 'State / Province';
$string['optional'] = 'optional';
$string['usercreated'] = 'User created successfully.';
$string['userscreated'] = '{$a} users created successfully.';
$string['usersfailed'] = '{$a} users failed to create.';
$string['usercreationresults'] = 'User Creation Results';
$string['passwordshownonce'] = 'Passwords are shown only once. Make sure to save them before leaving this page.';
$string['createnewusers'] = 'Create New Users';
$string['sm_estratoos_plugin:createusers'] = 'Create users via SmartMind plugin';

// Encryption key API.
$string['encryptionkey'] = 'Encryption Key';
$string['encryptionkeydesc'] = 'RSA key pair is auto-generated by the plugin. SmartLearning retrieves the private key via the get_encryption_key API to decrypt passwords.';

// User creation error codes.
$string['error_empty_firstname'] = 'First name cannot be empty.';
$string['error_empty_lastname'] = 'Last name cannot be empty.';
$string['error_empty_email'] = 'Email cannot be empty.';
$string['error_invalid_email'] = 'Invalid email format.';
$string['error_email_taken'] = 'Email address is already in use.';
$string['error_username_taken'] = 'Username is already in use.';
$string['error_invalid_username'] = 'Username contains invalid characters.';
$string['error_empty_password'] = 'Password is required when auto-generation is disabled.';
$string['error_password_policy'] = 'Password does not meet the security policy requirements.';
$string['error_invalid_birthdate'] = 'Birthdate must be in YYYY-MM-DD format.';
$string['error_invalid_phone_code'] = 'Phone country code must start with + followed by 1-4 digits (e.g. +55).';
$string['error_invalid_country'] = 'Country not recognized. Provide a valid ISO code (e.g. BR) or full name (e.g. Brazil).';
$string['error_encryption'] = 'Failed to encrypt password.';
$string['error_no_public_key'] = 'SmartLearning RSA public key is not configured. Set it in plugin settings.';
$string['error_user_creation_failed'] = 'Moodle user creation failed.';
$string['error_token_creation_failed'] = 'Token creation failed after user was created.';
